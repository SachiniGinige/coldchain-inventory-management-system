...
export default class EditMaintenaceRecord extends Component{
    constructor(props){
        super(props);
    ...
    componentDidMount(){
    axios.get(`http://localhost:3001/maintenancerec/get/${this.props.match.params.id}`)
        .then(response => { 
            ...
            this.setState({
                ...
                updatedDate: response.data.updatedDate.substring(0,10),
            })    
        })
    ...
    onSubmit(e){
        ...
        if(isValid){
            ...
            axios.put(`http://localhost:3001/maintenancerec/update/${this.props.match.params.id}`, mrecord)
            .then(res => console.log(res.data));
        
            alert("Maintenance Record edited"); 
    ...
    render() {
        return(
            ...
            <div className="form" id="editMainteanceRecordForm">
                <h3>Edit Maintenace Record</h3><br/>
                ...
                <button type="submit" className="btn btn-primary" onClick={this.onSubmit}>Edit Maintenance Request</button>
                <br/><br/><br/>                
            </div>
        );
    }
