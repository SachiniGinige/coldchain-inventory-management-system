        ...
        <div id="homepageContainer">            
            <div className="homepage" id="homepageContent"> 
                ...
                <div className="homeOptions center" id="option1">
                    {/* <p>Log in as User</p> */}
                    <Button className="homepageBtn" variant="outline-info" href="./login-user">User Login</Button>
                    <br/><br/>
                </div>
                <div className="homeOptions center" id="option2">
                    {/* <p>Log in as Admin</p> */}
                    <Button className="homepageBtn" variant="outline-info" href="./login-admin">Admin Login</Button>
                </div>
            </div>
